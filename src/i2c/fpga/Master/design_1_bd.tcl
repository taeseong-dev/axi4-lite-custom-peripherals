...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins ILMB] [get_bd_intf_pins ilmb_v10/LMB_M]
...
proc create_root_design { parentCell } {
 ...
 # Create instance: microblaze_0_axi_intc, and set properties
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins gpio8_upcnt_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins gpio8_upcnt_1/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins gpio8_upcnt_2/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins axi_i2c_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports GPIOB] [get_bd_pins gpio8_upcnt_1/io_port]
  connect_bd_net -net Net1 [get_bd_ports GPIOA] [get_bd_pins gpio8_upcnt_0/io_port]
  connect_bd_net -net Net2 [get_bd_ports GPIOC] [get_bd_pins gpio8_upcnt_2/io_port]
  connect_bd_net -net Net3 [get_bd_ports sda] [get_bd_pins axi_i2c_0/sda]
  connect_bd_net -net TMR_0_intr [get_bd_pins TMR_0/intr] [get_bd_pins microblaze_0_xlconcat/In0]
  connect_bd_net -intf_net axi_i2c_0_i2c_intr [get_bd_pins axi_i2c_0/i2c_intr] [get_bd_pins microblaze_0_xlconcat/In1]
  connect_bd_net -net axi_i2c_0_scl [get_bd_ports scl] [get_bd_pins axi_i2c_0/scl]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins TMR_0/s00_axi_aclk] [get_bd_pins axi_i2c_0/s00_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk ] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins gpio8_upcnt_0/s00_axi_aclk ] [get_bd_pins gpio8_upcnt_1/s00_axi_aclk ] [get_bd_pins gpio8_upcnt_2/s00_axi_aclk ] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk ] [get_bd_pins microblaze_0_axi_periph/ACLK]  [get_bd_pins microblaze_0_axi_periph/M00_ACLK]  [get_bd_pins microblaze_0_axi_periph/M01_ACLK]  [get_bd_pins microblaze_0_axi_periph/M02_ACLK]  [get_bd_pins microblaze_0_axi_periph/M03_ACLK]  [get_bd_pins microblaze_0_axi_periph/M04_ACLK]  [get_bd_pins microblaze_0_axi_periph/M05_ACLK]  [get_bd_pins microblaze_0_axi_periph/M06_ACLK]  [get_bd_pins microblaze_0_axi_periph/S00_ACLK]  [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_1/reset] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
  connect_bd_net -intf_net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -intf_net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins TMR_0/s00_axi_aresetn] [get_bd_pins axi_i2c_0/s00_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins gpio8_upcnt_0/s00_axi_aresetn] [get_bd_pins gpio8_upcnt_1/s00_axi_aresetn] [get_bd_pins gpio8_upcnt_2/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN]  [get_bd_pins microblaze_0_axi_periph/M00_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M02_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M03_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M04_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M05_ARESETN]  [get_bd_pins microblaze_0_axi_periph/M06_ARESETN]  [get_bd_pins microblaze_0_axi_periph/S00_ARESETN]  [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -intf_net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
