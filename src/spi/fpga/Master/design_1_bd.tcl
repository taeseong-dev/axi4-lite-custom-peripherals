...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins gpio8_upcnt_2/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports GPIOA] [get_bd_pins gpio8_upcnt_0/io_port]
  connect_bd_net -net Net1 [get_bd_ports GPIOB] [get_bd_pins gpio8_upcnt_1/io_port]
  ...
  connect_bd_net -net axi_spi_0_cs_n [get_bd_ports cs_n] [get_bd_pins axi_spi_0/cs_n]
  connect_bd_net -net axi_spi_0_mosi [get_bd_ports mosi] [get_bd_pins axi_spi_0/mosi]
  connect_bd_net -net axi_spi_0_sclk [get_bd_ports sclk] [get_bd_pins axi_spi_0/sclk]
  connect_bd_net -net axi_spi_0_spi_intr [get_bd_pins axi_spi_0/spi_intr] [get_bd_pins microblaze_0_xlconcat/In1]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins TMR_0/s00_axi_aclk] [get_bd_pins axi_spi_0/s00_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins gpio8_upcnt_0/s00_axi_aclk] [get_bd_pins gpio8_upcnt_1/s00_axi_aclk] [get_bd_pins gpio8_upcnt_2/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net miso_0_1 [get_bd_ports miso] [get_bd_pins axi_spi_0/miso]
  ...
  assign_bd_address -offset 0x40A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_spi_0/S00_AXI/S00_AXI_reg] -force
